...
qfbvar_schorf <- function(Y, prior_Pi_AR1, lambda1, lambda2, lambda3, n_lags, n_fcst, n_burnin, n_reps, verbose, ...) {
  ...
  burn_in <-  gibbs_sampler_schorf_qf(Y, prior_Pi_AR1, lambda1, lambda2, lambda3, n_lags, n_fcst = NULL, n_burnin,
  ...
  main_run <- gibbs_sampler_schorf_qf(Y, prior_Pi_AR1, lambda1, lambda2, lambda3, n_lags, n_fcst, n_reps,
