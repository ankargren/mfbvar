mfbvar_fsv <- function(x, ssng, ss, dl, ...) {
...
mcmc_sampler.mfbvar_minn_fsv <- function(x, ...){
  ...
  out <- mfbvar_fsv(x, ssng = FALSE, ss = FALSE, dl = FALSE, ...)
...
mcmc_sampler.mfbvar_dl_fsv <- function(x, ...){
  ...
  out <- mfbvar_fsv(x, ssng = FALSE, ss = FALSE, dl = TRUE, ...)
...
mcmc_sampler.mfbvar_ss_fsv <- function(x, ...){
  ...
  out <- mfbvar_fsv(x, ssng = FALSE, ss = TRUE, dl = FALSE, ...)
...
mcmc_sampler.mfbvar_ssng_fsv <- function(x, ...){
  ...
  out <- mfbvar_fsv(x, ssng = TRUE, ss = TRUE, dl = FALSE, ...)
