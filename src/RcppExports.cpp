...
BEGIN_RCPP
    ...
    mcmc_minn_csv(y_in_p, Pi, Sigma, Z, Z_fcst, phi, sigma, f, Lambda_comp, prior_Pi_Omega, inv_prior_Pi_Omega, Omega_Pi, prior_Pi_mean, prior_S, Z_1, priorlatent0, phi_invvar, phi_meaninvvar, prior_sigma2, prior_df, n_reps, n_q, T_b, n_lags, n_vars, n_T, n_fcst, n_thin, verbose);
    return R_NilValue;
END_RCPP
}
// mcmc_ss_csv
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::uword >::type n_thin(n_thinSEXP);
    Rcpp::traits::input_parameter< bool >::type verbose(verboseSEXP);
    mcmc_minn_iw(y_in_p, Pi, Sigma, Z, Z_fcst, Lambda_comp, prior_Pi_Omega, inv_prior_Pi_Omega, Omega_Pi, prior_Pi_mean, prior_S, Z_1, n_reps, n_q, T_b, n_lags, n_vars, n_T, n_fcst, n_thin, verbose);
    return R_NilValue;
END_RCPP
}
// mcmc_ss_iw
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_mfbvar_mcmc_minn_iw", (DL_FUNC) &_mfbvar_mcmc_minn_iw, 21},
